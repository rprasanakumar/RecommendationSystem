...
public class BookCountryAgeJac extends Configured implements Tool {

	
   public static void main( String[] args) throws  Exception {
      int res  = ToolRunner .run( new BookCountryAgeJac(), args);
      System .exit(res);
   }
...
//context.write(new Text(country+"######"+inputSequence[0]),new Text(""));
  context.write(new Text(inputSequence[3]),new Text(rating[0]+"######"+rating[1]));
...
//}
	    		  ...
	    		  context.write(new Text(movieId[0]+","+movieId[1]+","+movieId[2]), new Text(deciFormat.format(jaccard_coeff)));
	    		  context.write(new Text(movieId[0]+","+movieId[2]+","+movieId[1 ]), new Text(deciFormat.format(jaccard_coeff)));
