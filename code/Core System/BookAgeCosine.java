...
public class BookAgeCosine extends Configured implements Tool {

	
   public static void main( String[] args) throws  Exception {
      int res  = ToolRunner .run( new BookAgeCosine(), args);
      System .exit(res);
   }
...
//reducer calculates correlation score based on cosine formula for each pair of books
